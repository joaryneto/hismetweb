    ...
    <script src="<? echo $_SESSION['template'];?>/js/popper.min.js"></script>
    <script src="template/vendor/bootstrap-4.4.1/js/bootstrap.min.js"></script>

    <script type="text/javascript" src="<? echo $_SESSION['template'];?>/js/AjaxScript.js.php"></script>
    ...
    <!-- template custom js -->
    <script src="<? echo $_SESSION['template'];?>assets/js/main.js"></script>

    <script src="<? echo $_SESSION['template'];?>js/person.js"></script>
