...
<meta name="theme-color" content="#ffffff">
    ...
    <link rel="stylesheet" href="<? echo $_SESSION['template'];?>css/grid.css">
    <link rel="stylesheet" href="<? echo $_SESSION['template'];?>css/style.css">
    <link rel="stylesheet" href="<? echo $_SESSION['template'];?>css/camera.css">
    <link rel="stylesheet" href="<? echo $_SESSION['template'];?>css/owl-carousel.css">
	<link href="<? echo $_SESSION['template'];?>inc/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
	<link href="<? echo $_SESSION['template'];?>inc/vendors/font-awesome-pro/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="<? echo $_SESSION['template'];?>css/styleswitcher.css">
  ...
  <body>
    <div class="page">
      ...
      <header>
        <div class="container">
          <div class="brand">
            <img src="<? echo $_SESSION['template'];?>images/Logo/Logo_03.png" style="width: 150px;height: auto;padding: 25px;top: -15px;left: 30px;">
	...
	<script src="<? echo $_SESSION['template'];?>js/script.js"></script>
