          ...
          <div class="container">
            <nav class="nav">
              <ul data-type="navbar" class="sf-menu">
                ...
                <li class="active"><a href="index-1.html">Bio</a>
                  <ul>
              ...
              <div class="grid_6">
                ...
                <div class="row">
                  <div class="grid_3">
                    <dl class="info">
                      <dt>Name</dt>
                      <dd>Charles Powell</dd>
                      <dt>Birth Date</dt>
                      <dd>June 23, 1987 (age 28)</dd>
        ...
        <section class="well1">
          <div class="container">
            <div class="row">
              <div class="grid_4">
                <h2>Duties</h2>
                <p>Aenean ac leo eget nunc fringilla a non nulla! Nunc orci mi, venenatis quis ultrices vitae, congue non nibh. Nulla bibendum, justo eget ultrices vestibulum, erat tortor venenatis risus, sit amet cursus dui augue a arcu. Quisque</p>
              </div>
              <div class="grid_4">
                <h2>Skills</h2>
