	...
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no, user-scalable=no, maximum-scale=5"/>
    ...
    <link href="<? echo $_SESSION['template'];?>assets/vendor/elegant_font/HTMLCSS/style.css" rel="stylesheet">
