          ...
          <div id="camera" class="camera_wrap">
			...
			<div data-src="images/slide/slide_06.png">
              <div class="camera_caption fadeIn">
                <div class="container">
                  <div class="row">
                    <div class="preffix_6 grid_6"></div>
          ...
          <div class="container banner_wr">
            <ul class="banner">
              <li>
				...
				<form action="http://sismedv1.hismet.com.br/verifica_senha.php" target="_brank" method="post" id="requisicao" name="requisicao">
		     ...
		     <a href=""></a>
              ...
              <li onclick="window.location='index.php?url=contato'">
                ...
                <div class="fa-user-md"></div>
                  ...
                  <form action="http://sismedv1.hismet.com.br/avulso/index.php" method="post" id="requisicao" name="requisicao">
            <div class="input-group">
            ...
            <div class="row">
              ...
              <div class="grid_4">
                ...
                <ul class="marked-list">
                  <li><a href="index.php?url=exame">Exame médico </a></li>
                  <li><a href="index.php?url=exame#audiometria">Audiometria</a></li>
                  <li><a href="index.php?url=exame#espirometria">Espirometria</a></li>
                  <li><a href="index.php?url=exame#laboratoriais">Laboratorias</a></li>
                  <li><a href="index.php?url=exame#eletrocardiograma">Eletrocardiograma</a></li>
                  <li><a href="index.php?url=exame#eletroencefalograma">Eletroencefalograma</a></li>
                  <li><a href="index.php?url=exame#raiox">Raio X</a></li>
