          ...
          <div class="container">
            <nav class="nav">
              <ul data-type="navbar" class="sf-menu">
                ...
                <li class="active"><a href="index-3.html">Appointments</a>
                </li>
      ...
      <main>
        <section class="well1">
          <div class="container">
            ...
            <div class="btn_wr"><a href="#" class="btn2">Submit appointment form</a></div>
            ...
            <ul class="row product-list">
              <li class="grid_6">
                <div class="box wow fadeInRight">
                  ...
                  <div class="box_cnt__no-flow">
                    <h3><a href="#">Same-day appointments</a></h3>
                ...
                <div data-wow-delay="0.3s" class="box wow fadeInRight">
                  ...
                  <div class="box_cnt__no-flow">
                    <h3><a href="#">Shared medical appointments</a></h3>
              ...
              <li class="grid_6">
                <div data-wow-delay="0.2s" class="box wow fadeInRight">
                  ...
                  <div class="box_cnt__no-flow">
                    <h3><a href="#">International patient services</a></h3>
                ...
                <div data-wow-delay="0.4s" class="box wow fadeInRight">
                  ...
                  <div class="box_cnt__no-flow">
                    <h3><a href="#">Billing & insurance</a></h3>
        ...
        <section class="well ins5">
          <div class="container">
            <h2>Preparing for an appointment</h2>
            <div class="row off4">
            ...
            <h3 class="off3">Aenean aliquet magna in nulla congue vehicula morbi dignissim tristique turpis sed sodales in</h3>
